...
export interface JsRuntimeDescriptor {
  ...
  /** Minimum version yt-dlp supports, surfaced in diagnostics. */
  minVersion: string
  /**
...
export const JS_RUNTIME_PREFERENCE: readonly JsRuntimeDescriptor[] = [
  ...
  },
  {
    ...
    // QuickJS-NG >= 0.12.0 (and QuickJS >= 2025-04-26) carry the optimizations that keep a
    // challenge solve from taking minutes instead of seconds.
    minVersion: '0.12.0',
...
/** `QuickJS-ng version 0.17.0` / `qjs 0.17.0` -> `0.17.0` */
